<template>
  <div class="min-h-screen relative flex flex-col">
    ...
    <!-- Spatial lighting header -->
    <header class="spatial-header">
      <!-- Base glow layer -->
      <div class="header-glow-base"></div>
      
      <!-- Base light flash -->
      <div class="header-base-flash"></div>
    ...
    <!-- Spatial lighting footer -->
    <footer class="spatial-footer">
      <!-- Base glow layer -->
      <div class="footer-glow-base"></div>
      
      <!-- Base light flash -->
      <div class="footer-base-flash"></div>
